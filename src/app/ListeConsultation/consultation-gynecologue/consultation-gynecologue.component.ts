...
@Component({
  selector: 'app-consultation-gynecologue',
  templateUrl: './consultation-gynecologue.component.html',
  styleUrls: ['./consultation-gynecologue.component.css']
})
export class ConsultationGynecologueComponent implements OnInit {
  ...
  public getConsultations(): void{
    this.consultationService.findRdvByMedecin('Gynecologue').subscribe(
      (response: Consultation[])=>{
        this.consultations = response;
      },
      (error: HttpErrorResponse) =>{
