...
@Component({
  selector: 'app-consultation-pediatre',
  templateUrl: './consultation-pediatre.component.html',
  styleUrls: ['./consultation-pediatre.component.css']
})
export class ConsultationPediatreComponent implements OnInit {
  ...
  public getConsultations(): void{
    this.consultationService.findRdvByMedecin('Pediatre').subscribe(
      (response: Consultation[])=>{
        this.consultations = response;
      },
      (error: HttpErrorResponse) =>{
