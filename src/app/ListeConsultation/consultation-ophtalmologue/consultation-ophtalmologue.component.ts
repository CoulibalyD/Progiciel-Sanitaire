...
@Component({
  selector: 'app-consultation-ophtalmologue',
  templateUrl: './consultation-ophtalmologue.component.html',
  styleUrls: ['./consultation-ophtalmologue.component.css']
})
export class ConsultationOphtalmologueComponent implements OnInit {
  ...
  public getConsultations(): void{
    this.consultationService.findRdvByMedecin('Ophtalmologue').subscribe(
      (response: Consultation[])=>{
        this.consultations = response;
      },
      (error: HttpErrorResponse) =>{
