...
@Component({
  selector: 'app-consultation-generaliste',
  templateUrl: './consultation-generaliste.component.html',
  styleUrls: ['./consultation-generaliste.component.css']
})
export class ConsultationGeneralisteComponent implements OnInit {
  ...
  public getConsultations(): void{
    this.consultationService.findRdvByMedecin('Generaliste').subscribe(
      (response: Consultation[])=>{
        this.consultations = response;
      },
      (error: HttpErrorResponse) =>{
